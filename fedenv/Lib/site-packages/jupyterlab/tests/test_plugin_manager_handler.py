...
from jupyterlab.handlers.plugin_manager_handler import (
    PluginHandler,
...
async def test_pluginHandler_lock_extension(
    jp_serverapp, jp_fetch, make_labserver_extension_app
):
...
async def test_pluginHandler_unlock_extension(
    jp_serverapp, jp_fetch, make_labserver_extension_app
):
