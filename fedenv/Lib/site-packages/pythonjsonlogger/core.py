    ...
    *Added in UNRELEASED*: `exc_info_as_array` and `stack_info_as_array` options are added.
    ...
    def __init__(
        ...
        *Changed in 3.1*:
        ...
        self.reserved_attrs = set(
            reserved_attrs if reserved_attrs is not None else RESERVED_ATTRS
        )
    ...
    def formatException(self, ei) -> Union[str, list[str]]:  # type: ignore
        ...
        return (
            exception_info_str.splitlines()
            if self.exc_info_as_array
            else exception_info_str
        )
    ...
    def formatStack(self, stack_info) -> Union[str, list[str]]:  # type: ignore
        ...
        return (
            stack_info_str.splitlines() if self.stack_info_as_array else stack_info_str
        )
